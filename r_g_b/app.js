...
// console.log(moveRondomMonster(0, 2));
// console.log(battlemage.maxHealth);

// const startHealth = function () {
//   const mage = document.querySelector(".battleMage");
//   const monst = document.querySelector(".monster");
//   let health;
